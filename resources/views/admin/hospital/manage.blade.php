...
@section('content')
    <div class="page-content">
        ...
        <div class="page-heading">
            <h1>Hospital<small>Manage</small></h1>
            <div class="options">
            </div>
        </div>
        <div class="container-fluid">
            <div data-widget-group="group1">
                <div class="row">
                    <div class="col-md-12">
                        <a class="btn btn-lg btn-primary btn-raised btn-label" href="{{ route('admin.hospital.create') }}"><i class="fa fa-plus"></i> Add New Data<div class="ripple-container"></div></a>
...
<script>
    $(".hapus").click(function () {
        ...
        if(p==true){
            window.location = "<?= url('admin/hospital/delete') ?>/"+id;
        }else{
