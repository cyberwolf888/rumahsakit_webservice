...
@section('content')
    <div class="page-content">
        ...
        <div class="page-heading">
            <h1>Docter<small>Manage</small></h1>
            <div class="options">
            </div>
        </div>
        <div class="container-fluid">
            <div data-widget-group="group1">
                <div class="row">
                    <div class="col-md-12">
                        <a class="btn btn-lg btn-primary btn-raised btn-label" href="{{ route('hospital.docter.create') }}"><i class="fa fa-plus"></i> Add New Data<div class="ripple-container"></div></a>
                                    ...
                                    @foreach($model as $row)
                                        <tr>
                                            ...
                                            <td class="center" width="130">
                                                <a href="{{ route('hospital.docter.edit',$row->id) }}" class="btn btn-warning btn-raised btn-xs"><i class="fa fa-pencil"></i><div class="ripple-container"></div></a>
...
<script>
    $(".hapus").click(function () {
        ...
        if(p==true){
            window.location = "<?= url('hospital/docter/delete') ?>/"+id;
        }else{
